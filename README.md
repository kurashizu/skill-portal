...
├── skill-portal-worker.js # Built bundle (esbuild output) — what Cloudflare runs
...
> `skill-portal-worker.js` is regenerated by `npm run build` from `src/`. Do not edit it directly — edit `src/` and rebuild.
